export default async function handler(req, res) {
    ...
    const prompt = [
        ...
        '- nif: sin puntos ni guiones (ej: "12345678A" no "12.345.678-A")',
        ...
        '- tipo_socio: busca casillas de selección en la esquina superior derecha del formulario.',
        '  Si la casilla "Alta nueva" está marcada escribe "SOCIO".',
        '  Si la casilla "Incremento de cuota" o "Aumento de cuota" está marcada escribe "AUMENTO DE CUOTA".',
        '  Si no se ve ninguna casilla marcada deja vacío "".',
